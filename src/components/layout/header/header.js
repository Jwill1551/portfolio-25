...
export default function Header() {
    return (
        <header className="row portfolio-header py-6">
           <nav className="col portfolio-header__nav row">
               <ul class="portfolio-header__nav-list d-flex justify-content-evenly mx-auto mb-0 col-6 col-md-8 col-sm-10">
